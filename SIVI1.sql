...
CREATE VIEW V_STOCK_INSUMO AS
	SELECT  il.ID_INSUMO,l.ID_LOCAL,l.DIRECCION_LOCAL,il.STOCK_INSUMO_LOCAL, i.PRECIO_INSUMO, i.NOMBRE_UNICO_INSUMO
    FROM LOCAL l, INSUMO_LOCAL il, INSUMO i
    WHERE l.ID_LOCAL=il.ID_LOCAL and il.ID_INSUMO=i.ID_INSUMO
...
CREATE VIEW V_VENTA AS
	SELECT v.ID_VENTA, v.NUMERO_BOLETA_VENTA, u.NOMBRE_USUARIO AS NOMBRE_VENDEDOR, c.NOMBRE_CLIENTE AS NOMBRE_CLIENTE,l.DIRECCION_LOCAL,v.MONTO_TOTAL_VENTA, v.FORMA_DE_PAGO_VENTA,v.DESPACHADA_VENTA, v.FECHA_VENTA 
