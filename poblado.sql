...
(`NOMBRE_USUARIO`,`RUT_USUARIO`,`FECHA_NACIMIENTO_USUARIO`,`CORREO_USUARIO`,`TELEFONO_USUARIO`,`ROL_USUARIO`)
VALUES
...
('Maicol Mesa','15134135-4',19681205,'maicol.mesa@gmail.com','953244511','V'),
('Gerson Tapia','17134164-0',19510427,'gerson.tapia@gmail.com','','B'),
...
SET
`ID_LOCAL` = 2
WHERE `ID_BODEGUERO` = 6;

UPDATE `sivi`.`bodeguero`
SET
`ID_LOCAL` = 3
WHERE `ID_BODEGUERO` = 7;
...
`NUMERO_BOLETA_VENTA`)
VALUES
(4,1,2,sysdate(),'Efectivo',0,7680,true,2,1223),
(1,2,3,sysdate(),'Cheque',0,9440,true,2,1226),
(5,3,1,sysdate(),'Tarjeta',0,4800,true,2,1231),
(1,2,1,sysdate(),'Efectivo',0,5000,true,2,1311);
...
VALUES
(1,1,5,1,sysdate(),2400,'DEVOLUCION DEL DINERO',true);
...
`INSUMOS_DEFECTUOSOS_DEVOLUCION`)
VALUES
(2,2,1,1,sysdate(),'REPOSICION INSUMOS','Al parecer hay una falla de fábrica',true);
...
`PRECIO_COMPRA`)
VALUES
(1 ,1 ,4 ,1 ,'PO15' ,500 ,900 ),
(1 ,2 ,4 ,2 ,'PO16' ,500 ,1900),
(1 ,3 ,4 ,3 ,'PO17' ,500 ,4200),
(1 ,4 ,4 ,4 ,'PO18' ,500 ,4100),
(1 ,5 ,4 ,5 ,'PO19' ,500 ,1900),
(2 ,1 ,4 ,1 ,'PO15' ,500 ,900 ),
(2 ,2 ,4 ,2 ,'PO16' ,500 ,1900),
(2 ,3 ,4 ,3 ,'PO17' ,500 ,4200),
(2 ,4 ,4 ,4 ,'PO18' ,500 ,4100),
(2 ,5 ,4 ,5 ,'PO19' ,500 ,1900),
(3 ,1 ,4 ,1 ,'PO15' ,500 ,900 ),
(3 ,2 ,4 ,2 ,'PO16' ,500 ,1900),
(3 ,3 ,4 ,3 ,'PO17' ,500 ,4200),
(3 ,4 ,4 ,4 ,'PO18' ,500 ,4100),
(3 ,5 ,4 ,5 ,'PO19' ,500 ,1900);
...
`DESPACHO_LOCAL_GUIA`)
VALUES
(1,1,4,20160117100000,20160117160000,'','local 1',true),
(2,2,4,20160117100500,20160117150000,'','local 2',true),
(3,3,4,20160117101000,20160117170000,'','local 3',true);
