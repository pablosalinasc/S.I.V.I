...
class LocalControllerTest < ActionController::TestCase
  ...
  test "should create local" do
    assert_difference('Local.count') do
      post :create, local: { DIRECCION_LOCAL: @local.DIRECCION_LOCAL }
    end
  ...
  test "should update local" do
    patch :update, id: @local, local: { DIRECCION_LOCAL: @local.DIRECCION_LOCAL }
    assert_redirected_to local_path(assigns(:local))
  end
  ...
  test "should destroy local" do
    ...
    assert_redirected_to local_index_path
  end
end
